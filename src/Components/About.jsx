...
const About = () => {
  return (
    <div className='flex flex-col w-auto'>
      <div className='bg-[#EDEDED]  flex w-full'>
        <div className='flex p-24 w-[200%] font-bold text-green-700 lg:text-[15px] lg:p-10 xl:p-24 md:p-8 md:text-[10px] xl:text-[20px]'>
        <span>
        ...
        <div className='flex w-[180%] h-auto justify-center items-center '>
        <img src={img} className="h-[70%]" alt="subway"/>
        </div>
      </div>
      <div className='bg-[#008938] flex w-full h-full p-10 flex-col justify-between '>
        ...
        <p className='px-32 text-white font-semibold mt-6 pt-2 border-t-2 border-yellow-400 xl:text-[18px] lg:text-[15px] md:text-[12px] md:px-12 lg:px-32'>All rights reserved. SUBWAY® is a Registered Trademark of Subway IP LLC. ©2022 Subway IP LLC., and is licensed to Eversub India Private Limited under an exclusive master franchisee arrangement for the territory of the Republic of India.</p>
      </div>
