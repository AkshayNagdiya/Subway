...
const Menuherosection = () => {
  ...
  return (
    <div className='text-center'>
      ...
      <div className=' pt-10 bg-cover flex flex-col justify-center' style={{backgroundImage:`url(${img})`}}>
        <img src={img4} style={{width:'700px',marginInline:'100px', padding:'20px'}} alt="img" />
      ...
      <div className='pt-10 bg-cover flex-col h-auto justify-center bg-white'>           
        <div className='container flex h-auto w-fit flex-wrap justify-center'>
          {
            products.slice(0,6).map(products => <Menuitems key={products.id} products={products}/>)
          }
        </div>      
        <div className='flex pl-32 '>
      ...
      <div className='pt-10 bg-cover flex-col h-auto justify-center bg-[#008045]'>           
        <div className='container flex h-auto w-fit flex-wrap justify-center'>
          {
            products.slice(6,12).map(products => <Menuitems key={products.id} products={products}/>)
          }
        </div>      
      </div>
      ...
      <div className='flex flex-wrap justify-between '>
        <div className='flex justify-end'>
          <h1 className='text-green-600 pt-20 text-[50px]'>INTRODUCING</h1>
          <h1 className='text-green-600 font-extrabold pt-40 text-[50px]'> CRISPERS</h1>
          <img src={img5} alt="img" style={{width:'60%'}}/>
        </div>
      </div>
